...
export default async function ProcurementInvoiceDetailPage({
  params,
}: {
        ...
        <CardBody>
          <dl className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <dd className="mt-1">
                <Link href={`/procurement/purchase-orders/${invoice.poId}`} className="text-indigo-600 hover:underline">
